...
public class PaintingActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(PaintingActivity.this,LoginActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Projects, ProjectViewHolder> FBRA = new FirebaseRecyclerAdapter<Projects, PaintingActivity.ProjectViewHolder>(
                Projects.class,
                R.layout.viewprojects_row,
                PaintingActivity.ProjectViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(PaintingActivity.ProjectViewHolder viewHolder, Projects model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleInstaActivity = new Intent(PaintingActivity.this, SinglePaintingActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAuth.signOut();
            Intent intent= new Intent(PaintingActivity.this,SignupActivity.class);
