...
public class FrameActivity extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(FrameActivity.this,LoginActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Projects, ProjectViewHolder> FBRA = new FirebaseRecyclerAdapter<Projects, FrameActivity.ProjectViewHolder>(
                Projects.class,
                R.layout.viewprojects_row,
                FrameActivity.ProjectViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(FrameActivity.ProjectViewHolder viewHolder, Projects model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleInstaActivity=new Intent(FrameActivity.this,SingleProjectFrame.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            mAuth.signOut();
            Intent intent= new Intent(FrameActivity.this,SignupActivity.class);
