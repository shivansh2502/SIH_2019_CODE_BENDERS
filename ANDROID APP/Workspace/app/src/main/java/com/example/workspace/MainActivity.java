...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Projects, ProjectViewHolder> FBRA = new FirebaseRecyclerAdapter<Projects, MainActivity.ProjectViewHolder>(
                Projects.class,
                R.layout.viewprojects_row,
                MainActivity.ProjectViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(MainActivity.ProjectViewHolder viewHolder, Projects model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleInstaActivity=new Intent(MainActivity.this,SingleProjectActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent= new Intent(MainActivity.this,ViewCustomerProject.class);
            startActivity(intent);
        }
